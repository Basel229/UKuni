...
<div class="row">
	...
	<div class="col-lg-8">
		...
		<img src="{{ asset('images/canada.jpg') }}">&nbsp;<p style="font-size: 20px; text-align: left;color: #1f0949;">{{ $dataselected->university}}</p>
	...
	<div class="col-lg-3 " >
		...
		<form method="post" action="{{ route('getcanadaselecteduniversitydata') }}" style="background-color: #f8f8f8;padding: 15px;" >
