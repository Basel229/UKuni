...
<div class="row">
	...
	<div class="col-lg-8">
		...
		<img src="{{ asset('images/newzealand.jpg') }}">&nbsp;<p style="font-size: 20px; text-align: left;color: #1f0949;">{{ $dataselected->university}}</p>
			...
			<div class="col-lg-12">
				<table class="table table-striped">
					...
					<tr style="background-color: #f8f8f8;font-weight: 700;">
						...
						<td><img src="{{ asset('images/detailed_page_icon/full-part-time.png') }}" style="width: 28%"    ><br>{{$dataselected->degree_title}}</td>
	...
	<div class="col-lg-3 " >
		...
		<form method="post" action="{{ route('getnzselecteduniversitydata') }}" style="background-color: #f8f8f8;padding: 15px;" >
