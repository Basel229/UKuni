      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('viewuser',app()->getlocale())}}">User's List</a>
            <a class="collapse-item" href="{{ route('viewuniversities',app()->getlocale())}}">University List</a>
            <a class="collapse-item" href="{{ route('pendingaccounts',app()->getlocale())}}">Pending Users</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('adminviewcourses',app()->getlocale())}}">View Courses</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('generalinquiry',app()->getlocale())}}">General Query Forms</a>
            <a class="collapse-item" href="{{ route('immigrationinquiry',app()->getlocale())}}">Immigration & Citizenship</a>
          </div>
        </div>
      </li>
