		...
		<form method="post" action="{{ route('getquerydata',app()->getLocale()) }}" style="background-color: #f8f8f8;padding: 15px;" >
			...
			<input type="number" name="gpa" class="form-control" placeholder="Enter GPA" step=any required><br>
			<input type="text" name="subject" class="form-control" placeholder="Enter your Subject" required><br>
			...
			<input type="text" name="preferred_destination" class="form-control" placeholder="Preferred Destination" required><br>
