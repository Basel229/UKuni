...
<div class="row">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/ukuni_slider/study_in_canada.jpg" alt="Los Angeles" width="1100" height="300">
...
<div class="row">
	...
	<div class="col-lg-11">
		...
		<div class="row" >
			...
			<div class="col-lg-6 " >
				<img src="images/canada_university/{{$value->university}}.png"
			...
			<div class="col-lg-6 div_background" style="height: auto;">
				...
				<a href="{{ route('canadaselectedcourse',['id'=>$value->id]) }}" class="btn btn-success" style="color: #fff;">Apply Now</a>
			</div>
