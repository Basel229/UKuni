...
<div class="row">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/ukuni_slider/study_in_newzealand.jpg" alt="Los Angeles" width="1100" height="300">
      <div class="carousel-caption" >
        <h1 style="font-size: 50px;">STUDY IN Australia</h1>
...
<div class="row">
	...
	<div class="col-lg-11">
		...
		<div class="row" >
			...
			<div class="col-lg-6 " >
				<img src="images/aus_university/{{$value->university}}.png"
			...
			<div class="col-lg-6 div_background" style="height: auto;">
				...
				<a href="{{ route('ausselectedcourse',['id'=>$value->id]) }}" class="btn btn-success" style="color: #fff;">Apply Now</a>
			</div>
