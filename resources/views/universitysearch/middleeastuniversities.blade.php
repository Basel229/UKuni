...
<div class="row">
	...
	<div class="col-lg-11">
		...
		<div class="row" >
			...
			<div class="col-lg-6 " >
				<img src="images/middleeast_university/{{$value->university}}.png"
			...
			<div class="col-lg-6 div_background" style="height: auto;">
				...
				<a href="{{ route('middleeastselectedcourse',['id'=>$value->id]) }}" class="btn btn-success" style="color: #fff;">Apply Now</a>
			</div>
