...
<div class="row">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/ukuni_slider/study_in_middleeast.jpg" alt="Los Angeles" width="1100" height="300">
      <div class="carousel-caption" >
        <h1 style="font-size: 50px;">STUDY IN MIDDLE EAST</h1>
...
<div class="row" style="background-color: #eb1e25;">
	...
	<div class="col-lg-8" ><br>
		<p style="font-size: 35px; text-align: center;color: #fff;">Search <strong style="font-size: 35px; color: #fff;">In Middle East. . . </strong></p>
   ...
   <form method="get" action="{{ route('middleeastuniversities') }}" class="form-inline">
